...
public class EditarProducto extends JPanel {
	...
	public JButton btnModificarImagenes;
	...
	public EditarProducto() {
		...
		JLabel lblNewLabel_1_1 = new JLabel("EDITAR PRODUCTO:");
		...
		btnSeleccionarImagen = new JButton("CAMBIAR IMAGEN PRINCIPAL");
		...
		btnModificarImagenes = new JButton("MODIFICAR IMAGENES");
		btnModificarImagenes.setForeground(Color.BLACK);
		btnModificarImagenes.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 12));
		btnModificarImagenes.setBackground(Color.BLUE);
		btnModificarImagenes.setBounds(539, 466, 145, 29);
		add(btnModificarImagenes);

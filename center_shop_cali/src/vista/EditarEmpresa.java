...
public class EditarEmpresa extends JPanel {
	...
	public EditarEmpresa() {
		...
		JLabel lblNewLabel_1_1 = new JLabel("EDITAR EMPRESA:");
		...
		btnCrear.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 12));
		...
		textDireccion.setHorizontalAlignment(SwingConstants.RIGHT);
		textDireccion.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 20));
		textDireccion.setColumns(10);
		textDireccion.setBounds(723, 274, 258, 30);
		add(textDireccion);
		...
		JLabel lblCorreo_1_1_1 = new JLabel("NUEVA CONTRASEÑA:");
		...
		btnSeleccionarLogo = new JButton("CAMBIAR LOGO");
		btnSeleccionarLogo.setForeground(new Color(0, 0, 255));
		btnSeleccionarLogo.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 12));
		btnSeleccionarLogo.setBackground(new Color(255, 255, 255));
